...
export default function Page() {
    ...
    <main className="w-full grow h-full p-8 flex flex-col items-center justify-start gap-8">
      <div className="w-full flex flex-row items-center justify-between md:justify-end gap-4">
        <button className="group flex flex-row items-center gap-3 cursor-pointer text-white/70 hover:text-white hover:scale-[1.05] transition-all duration-500 ease-in-out border border-white/20 px-3 py-1.5 rounded-2xl">
